...
const points = [
  "Approximately 40 minutes from Yeshwantpur",
  "20 minutes from NH48/Nelamangala Junction",
  "Easy access to Nelamangala Railway Station",
  "30m from Doddaballapur/Satellite Town Ring Road",
  "10m from Chikka Madhure Temple",
]
            ...
            <div className="mt-5 grid flex-1 grid-cols-1 gap-5 md:mt-8 md:grid-cols-[44%_56%] md:gap-10">
              ...
              <div className="order-1 md:order-2">
                <p className="text-[16px] leading-relaxed md:text-[18px] text-black!">
                  A decade ago, Chartered Veda plots were priced at Rs.
                  1,800/sft. Today they trade at Rs. 5,500/sft. Chartered
                  Gulmohar Bengaluru is in the same corridor at the early stage
                  of that same curve.
                </p>
